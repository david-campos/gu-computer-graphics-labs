...
void display() {
    ...
    ///////////////////////////////////////////////////////////////////////////
    FboInfo &screenFB = fboList[1];
    glBindFramebuffer(GL_FRAMEBUFFER,
                      screenFB.framebufferId); // to be replaced with another framebuffer when doing post processing
    glViewport(0, 0, w, h);
    ...
    glBindTexture(GL_TEXTURE_2D, screenFB.colorTextureTarget);
    labhelper::drawFullScreenQuad();

    FboInfo &horizontalBlurBuffer = fboList[2];
    glUseProgram(horizontalBlurShader);
    glBindFramebuffer(GL_FRAMEBUFFER, horizontalBlurBuffer.framebufferId);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, screenFB.colorTextureTarget);
    labhelper::drawFullScreenQuad();
    ...
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, horizontalBlurBuffer.colorTextureTarget);
    labhelper::drawFullScreenQuad();
    ...
    FboInfo &verticalBlurBuffer = fboList[3];
    glUseProgram(verticalBlurShader);
    glBindFramebuffer(GL_FRAMEBUFFER, verticalBlurBuffer.framebufferId);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, horizontalBlurBuffer.colorTextureTarget);
    labhelper::drawFullScreenQuad();
    ...
    glBindTexture(GL_TEXTURE_2D, verticalBlurBuffer.colorTextureTarget);
